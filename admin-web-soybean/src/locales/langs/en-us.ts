const local: App.I18n.Schema = {
  ...
  route: {
    ...
    point_management_old: 'Point Management (Legacy)',
    task: 'Task Center',
    task_center: 'Task Center',
    task_center_list: 'Task List',
    task_center_detail: 'Task Details',
    task_center_map: 'Task Map',
    audit: 'Audit Management',
    audit_list: 'Audit List',
    audit_detail: 'Audit Details',
    template: 'Template Management',
    template_list: 'Template List',
    template_design: 'Form Designer',
    export: 'Export Center',
    export_list: 'Export Tasks',
    ...
    system_collab: 'Collaboration Entry'
  },
  page: {
    login: {
      common: {
