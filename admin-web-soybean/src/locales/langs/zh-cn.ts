const local: App.I18n.Schema = {
  ...
  route: {
    ...
    task: '任务中心',
    task_center: '任务中心',
    task_center_list: '任务列表',
    task_center_detail: '任务详情',
    task_center_map: '任务地图',
    point_management: '点位管理',
    point_management_old: '点位管理(旧版)',
    point_map: 'GIS 一张图',
    audit: '审核中心',
    audit_list: '审核列表',
    audit_detail: '审核详情',
