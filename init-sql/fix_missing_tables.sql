...
CREATE TABLE IF NOT EXISTS survey_audit_record (
  ...
  action VARCHAR(20) NOT NULL COMMENT '操作：pass/reject/transfer',
  audit_comment TEXT COMMENT '审核意见',
  reject_template_id BIGINT COMMENT '驳回模板ID',
  create_time DATETIME DEFAULT CURRENT_TIMESTAMP,
...
-- 插入默认角色（admin的密码已在前一次修复中更新为正确的BCrypt）
...
-- 为admin用户分配管理员角色（假设admin的id为2，根据前面查询结果）
INSERT IGNORE INTO sys_user_role (user_id, role_id) VALUES (2, 1);

-- 插入测试用户（密码均为 admin123 的 BCrypt）
INSERT IGNORE INTO sys_user (username, password, real_name, role, status) VALUES
('surveyor1', '$2b$10$s50YS5BkiExwvw5EEpBZf.utQu174fg1ueWxYa6BydC3ziWNkMbXa', '张志明', 2, 1),
('surveyor2', '$2b$10$s50YS5BkiExwvw5EEpBZf.utQu174fg1ueWxYa6BydC3ziWNkMbXa', '李晓华', 2, 1),
('surveyor3', '$2b$10$s50YS5BkiExwvw5EEpBZf.utQu174fg1ueWxYa6BydC3ziWNkMbXa', '王建国', 2, 1),
('reviewer1', '$2b$10$s50YS5BkiExwvw5EEpBZf.utQu174fg1ueWxYa6BydC3ziWNkMbXa', '陈美丽', 3, 1),
('reviewer2', '$2b$10$s50YS5BkiExwvw5EEpBZf.utQu174fg1ueWxYa6BydC3ziWNkMbXa', '刘强', 3, 1);
